    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 space-y-6 animate-fade-in">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-foreground mb-2">Gestion des paiements</h1>
            <p className="text-sm sm:text-base text-muted-foreground">Suivi des encaissements et paiements de scolarité</p>
          </div>
                    ...
                    <div key={payment.id} className="bg-card border rounded-lg p-4 space-y-3">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <p className="font-semibold text-foreground">{payment.students?.full_name}</p>
                          <p className="text-xs text-muted-foreground">{payment.students?.matricule}</p>
                        </div>
                        <Badge variant="outline" className="text-xs">{getTypeLabel(payment.payment_type)}</Badge>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-muted-foreground">{payment.students?.class}</span>
                        <span className="font-bold text-green-600 text-lg">{payment.amount.toLocaleString()} FCFA</span>
                      </div>
